...
def format_report_index(reports):
    ...
    return (
        ...
        "    <div>\n"
        "      <h1 class=\"title\">Pension report history</h1>\n"
        "      <div class=\"meta\">Browse the last 14 generated reports, filter by date, and view or download the latest snapshots.</div>\n"
        "    </div>\n"
        "    <div class=\"stats\"><span id=\"result-count\">Loading reports...</span></div>\n"
        "  </div>\n"
        ...
        "    <label class=\"filter-field\">\n"
        "      Search reports\n"
        "      <input id=\"search-input\" type=\"search\" placeholder=\"Search by file name\" autocomplete=\"off\" />\n"
        "    </label>\n"
        "  </div>\n"
        "  <p class=\"range-note\">Showing the most recent 14 days by default. Use search to narrow by file name.</p>\n"
        ...
        "    const fileText = (r.html + ' ' + r.xlsx).toLowerCase();\n"
        "    return r.date >= clamped.start && r.date <= clamped.end && fileText.includes(query);\n"
        "  });\n"
        ...
        "        <div class=\"report-subtitle\">${r.html}</div>\n"
        "      </div>\n"
        "      <div class=\"report-links\">\n"
        "        <a class=\"link-pill\" href=\"${r.html}\">Open</a>\n"
        "        <a class=\"link-pill\" href=\"${r.xlsx}\" download>Download</a>\n"
        "      </div>\n"
...
def main():
    ...
    try:
        ...
        html_content = (
            ...
            "            <a class=\"back-link\" href=\"index.html\">← Back to history</a>\n"
            "            <input id=\"filter-input\" class=\"filter-input\" placeholder=\"Filter funds…\" aria-label=\"Filter funds\">\n"
