...
def format_report_index(reports, trigger_api_url):
    ...
    return (
        ...
        "  updateLastCheckLabel();\n"
        "  // Always include all published dates listed in the generated index.\n"
        "  const globalDates = getGlobalSortedReports().map(function(r){ return r.date; });\n"
        "  saveVisibleDates(readVisibleDates().concat(globalDates));\n"
