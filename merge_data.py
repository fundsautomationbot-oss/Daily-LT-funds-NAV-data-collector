...
def main():
    ...
    try:
        ...
        html_content = (
            ...
            "const WORKFLOW_URL = `https://github.com/${GITHUB_REPO}/actions/workflows/${WORKFLOW_FILE}`;\n"
            ...
            "    showNotification('Opened workflow page. Click Run workflow there, then return here.', 'warning');\n"
            "    return 'manual';\n"
            "  }\n"
            "  try {\n"
            ...
            "      window.open(WORKFLOW_URL, '_blank', 'noopener');\n"
            "      showNotification('Token rejected. Opened workflow page for manual Run workflow.', 'error');\n"
            "      return 'manual';\n"
            "    }\n"
            ...
            "    const triggerMode = await triggerWorkflow();\n"
            "    if (!triggerMode) {\n"
            "      return;\n"
            "    }\n"
            "    if (triggerMode === 'api') {\n"
            ...
            "    } else {\n"
            "      showNotification('Waiting for publish after manual workflow run...', 'info');\n"
            "    }\n"
