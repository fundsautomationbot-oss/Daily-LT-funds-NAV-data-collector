...
def format_report_index(reports, trigger_api_url):
    ...
    return (
        ...
        "  });\n"
        "  if (!sorted.length) {\n"
        "    document.getElementById('report-content').innerHTML = '<p class=\"text-slate-500 text-sm text-center py-16\">No reports on this device yet.<br>Tap &ldquo;Generate for this device&rdquo; to load the latest data.</p>';\n"
        "  } else {\n"
