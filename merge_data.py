...
def format_report_index(reports, trigger_api_url):
    ...
    return (
        ...
        "          <div id=\"report-content\" class=\"p-6 text-center text-slate-400 text-sm py-16\">Tap &ldquo;Generate for this device&rdquo; to load reports on this browser.</div>\n"
        "        </div>\n"
        "      </div>\n"
        "    </section>\n"
        "  </main>\n"
        ...
        "  body.innerHTML = '<p class=\"text-slate-400 text-sm text-center py-16\">Loading report\u2026</p>';\n"
        "  try {\n"
        ...
        "    if (window.location.protocol === 'file:' || msg === 'Failed to fetch') {\n"
...
def main():
    ...
    try:
        ...
        html_content = (
            ...
            "    if (window.location.protocol === 'file:' || detail === 'Failed to fetch') {\n"
